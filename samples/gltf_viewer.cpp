...
static void printUsage(char* name) {
    ...
    std::string usage(
            ...
            "       Specify the feature level to use. The default is the highest supported feature "
            "level.\n\n"
            ...
            "       Sets the number of stereoscopic eyes (default: 2) when stereoscopic rendering "
            "is\n"
            "       enabled.\n\n"
            "   --split-view, -v\n"
            ...
            "       You can force WebGPU to select a backend of your choice. Provided that the "
            "platform\n"
            "       supports this backend. (See -a for argument options).\n\n"
            "   --remote, -x\n"
            "       Run in remote web-server headless mode streaming view to port 8888\n\n");
